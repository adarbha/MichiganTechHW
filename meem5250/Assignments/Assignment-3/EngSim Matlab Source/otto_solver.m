function [x3,X1,prod_h] = otto_solver(x1,x2,v,P,phi,temp_d,species_data,prod_data,prod_thdata,int_energy_2)

%   Solves heat addition process for equilibrium otto cycle.
%
...
%   equilibrium composition and enthalpy every iteration, based
...
while err > merr & it < mit
   ...
   k = 2;
   [X1,P1]=eq_solver(species_data,prod_data,phi,x2,P,v);
   prod_data(:,1) = X1;
   ...
   f1 = feval('eq_ottoc',x1,temp_d,prod_h,int_energy_2);

   f2 = feval('eq_ottoc',x2,temp_d,prod_h,int_energy_2);
