function [x3,X1,M_resid,prod_h] = lp_solver(x1,x2,v,P,phi,temp_d,species_data,prod_data,prod_thdata,enthalpy_2a)

%   Solves heat addition process for equilibrium, limited pressure cycle.
%
...
while err > merr & it < mit
   ...
   f1 = feval('eq_lpc',x1,temp_d,prod_h,enthalpy_2a);

   f2 = feval('eq_lpc',x2,temp_d,prod_h,enthalpy_2a);
